    ...
    <div className="flex items-center gap-3">
      {links.map((l) => (
        <a
          ...
          aria-label={`Distribuie pe ${l.label}`}
          className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border text-foreground/70 transition-colors hover:border-brand hover:text-brand"
        >
